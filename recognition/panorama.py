...
def calcMatchingMat(img_gray1, img_gray2) :

    #key point detection keyPt:点配列, des:特徴ベクトル配列
    #detector = cv2.xfeatures2d.SURF_create()
    #detector = cv2.xfeatures2d.SIFT_create()
    detector = cv2.AKAZE_create()
    keyPt1, des1 = detector.detectAndCompute(img_gray1, None)
    keyPt2, des2 = detector.detectAndCompute(img_gray2, None)
    ...
    if( VIS_FOR_DEBUG ) :
        ptimg1 = visKeyPoints(img_gray1, point1)
        ptimg2 = visKeyPoints(img_gray2, point2)
        visImg = visMatching (img_gray1, img_gray2, point1, point2)
...
def panorama(img1, img2) :
    ...
    Mat = calcMatchingMat( gray1, gray2)
    print(Mat)
...
#main
img1 = cv2.imread("../imgs/pano1.JPG")
img2 = cv2.imread("../imgs/pano2.JPG")
img3 = cv2.imread("../imgs/pano3.JPG")
img4 = cv2.imread("../imgs/pano4.JPG")

res = panorama(img1, img2)
res = panorama(res , img3)
res = panorama(res , img4)
